...
import com.cloudstorage.models.CredentialForm;
import com.cloudstorage.models.FileForm;
import com.cloudstorage.models.NoteForm;
...
public class HomeController {
    ...
    public String newFile(
            Authentication authentication, @ModelAttribute("newFile") FileForm newFile,
            @ModelAttribute("newNote") NoteForm newNote, @ModelAttribute("newCredential")
                    CredentialForm newCredential, Model model) throws IOException, IOException {
        String userName = authentication.getName();
        User user = userService.getUser(userName);
